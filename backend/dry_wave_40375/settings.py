"""
Django settings for dry_wave_40375 project.
...
ROOT_URLCONF = 'dry_wave_40375.urls'
...
WSGI_APPLICATION = 'dry_wave_40375.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_wave_40375 API",
    "DESCRIPTION": "API documentation for dry_wave_40375 App",
    "VERSION": "v1",
}
